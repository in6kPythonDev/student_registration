...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AboutInfo.test_migration'
        db.add_column('student_form_aboutinfo', 'test_migration',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AboutInfo.test_migration'
        db.delete_column('student_form_aboutinfo', 'test_migration')
